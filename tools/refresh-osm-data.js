...
(
  ...
  way(area.searchArea)[traffic_calming];
  way(area.searchArea)[noexit];
  way(area.searchArea)[no_exit];
  node(area.searchArea)[shop];
  node(area.searchArea)[amenity];
  node(area.searchArea)[office];
  node(area.searchArea)[natural=tree];
  node(area.searchArea)[traffic_calming];
  node(area.searchArea)[noexit];
  node(area.searchArea)[no_exit];
);
out body;
>;
out skel qt;
